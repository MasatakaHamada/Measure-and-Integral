...
%\begin{proof}
%$(a_1,b_1]=\displaystyle\bigcap_{n=1}^\infty(a_1,b_1+n^{-1})
%=(0,1]\cap\bigcap_{n=1}^\infty(a_1,b_1+n^{-1})
%=\bigcap_{n=1}^\infty[(0,1]\cap(a_1,b_1+n^{-1})]$
%より$\Sigma_0\subseteq\mathcal{B}(0,1]$すなわち$\sigma(\Sigma_0)\subseteq\mathcal{B}(0,1]$．
%$\mathbb{R}$の開集合$O$に対し$(0,1] \cap O\in\sigma(\Sigma_0)$であることを示す．
%問\ref{qst_real_open_set_is_countable_union_of_open_interval}より
%$O=\displaystyle\bigcup_{n=1}^\infty(a_n,b_n)$であるから
%$(0,1] \cap O=(0,1] \cap\displaystyle\bigcup_{n=1}^\infty(a_n,b_n)$
%\end{proof}
